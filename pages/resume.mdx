...
import { LastUpdated } from '../components/utils/LastUpdated';
import { getLastUpdated } from '../utils/githubCommits';

export const getStaticProps = async () => {
  const lastUpdated = await getLastUpdated({path: 'pages/resume.mdx'});
